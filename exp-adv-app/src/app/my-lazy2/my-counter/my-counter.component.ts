...
import { increment, decrement, reset } from '../common/store/actions/counter.actions';
import { disablePub, enablePub , togglePub} from '../common/store/actions/pub.actions';
...
//constructor(private store: Store<AppState>,...) {
  constructor(private store: Store<{count:number,pub:boolean}>,
